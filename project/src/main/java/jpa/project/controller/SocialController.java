...
//    @GetMapping("/logout")
//    public ModelAndView socialKakaoLogout(ModelAndView mav) {
//        StringBuilder logoutUrl = new StringBuilder()
//                .append(env.getProperty("spring.social.kakao.url.logout"))
//                .append("?client_id=").append(kakaoClientId)
//                .append("&response_type=code")
//                .append("&redirect_uri=").append(kakaoRedirect);
//        mav.addObject("logoutUrl", logoutUrl);
//        mav.setViewName("social/logout");
//        return mav;
//    }
